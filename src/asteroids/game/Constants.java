...
public class Constants
{
     ...
     */
    public final static double SHIP_ACCELERATION = 0.65;
    ...
    /**
     * The average offset in pixels from the edges of the screen of newly-placed asteroids. Coordinate 150.
     */
    public final static int EDGE_OFFSET = 150;

    /**
     * The average offset in pixels from the edges of the screen of newly-placed asteroids. Coordinate 650.
     */
    public final static int EDGE_OFFSET2 = 650;
    ...
    /**
     * Zig Zag factors used for Alien Ship's path from right to left
     */
    public final static double[] RIGHT_ZIG_ZAG = { 0, 7 * Math.PI / 4, Math.PI / 4 };

    /**
     * Zig Zag factors used for Alien Ship's path from left to right
     */
    public final static double[] LEFT_ZIG_ZAG = { Math.PI, 3 * Math.PI / 4, 5 * Math.PI / 4 };

    /**
     * Zig Zag factors used for Alien Ship's direction
     */
    public final static double[] ZIG_ZAG[] = { RIGHT_ZIG_ZAG, LEFT_ZIG_ZAG };

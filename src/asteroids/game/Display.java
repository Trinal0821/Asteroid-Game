...
public class Display extends JFrame
{
    ...
    //sets the asteroid stats
    public void setAsteroidStatics (String s) {
        screen.asteroidStatistics(s);
    }
    
    //sets the small alien ship stats
    public void setSmallShipStatics (String s) {
        screen.smallStatistics(s);
    }
    
    //sets the large alien ship stats
    public void setLargeShipStatics (String s) {
        screen.largeStatistics(s);
    }
}
